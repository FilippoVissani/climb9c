...
INSERT INTO `climb_9c`.`category` (`idCATEGORY`, `name`) VALUES (1, "Abbigliamento");

-- insert sulle sottocategorie 

INSERT INTO `climb_9c`.`subcategory` (`idSUBCATEGORY`, `idCATEGORY`, `name`) VALUES (1, 1, "Scarpe");

INSERT INTO `climb_9c`.`subcategory` (`idSUBCATEGORY`, `idCATEGORY`, `name`) VALUES (2, 1, "Caschi");

-- insert sul prodotto

-- 1
INSERT INTO `climb_9c`.`product` (`idPRODUCT`, `name`, `brand`, `price`, `idSUBCATEGORY`, `description`, `tecnical_specifications`, `quantity`) VALUES (1, "5.10 Five Ten Aleon VCS scarpette arrampicata", "Five Ten", "99.70", 1, "5.10 Five Ten Aleon VCS sono delle scarpette da arrampicata pensata per il boulder o per l'arrampicata in falesia. Tra tutte le novità da parte di Adidas Five Ten, le Aleon sono sicuramente le scarpette che meritano uno sguardo in più.
...
Attenzione! Le scarpette da arrampicata 5.10 Five Ten vestono poco. Prima quindi di procedere all'acquisto prova a vedere qui sotto i numeri consigliati da noi.", "archio
Five Ten
Chiusura
Strappo
Utilizzo scarpetta
...
Stesso numero
Consigliato rispetto alla taglia normale - Calzata performante
Stesso numero, Mezzo numero in meno", 5);

-- 4
INSERT INTO `climb_9c`.`product` (`idPRODUCT`, `name`, `brand`, `price`, `idSUBCATEGORY`, `description`, `tecnical_specifications`, `quantity`) VALUES (4, "5.10 Five Ten Anasazi Pro scarpette arrampicata", "Five Ten", 115.95, 1, "La scarpetta da arrampicata e boulder  Anasazi Pro di 5.10 Five Ten è polivalente e combina sensibilità e potenza per l'arrampicata a 360 gradi.
...
Consigliato rispetto alla taglia normale - Calzata media
Mezzo numero in più
Consigliato rispetto alla taglia normale - Calzata performante", 7);

-- 5
INSERT INTO `climb_9c`.`product` (`idPRODUCT`, `name`, `brand`, `price`, `idSUBCATEGORY`, `description`, `tecnical_specifications`, `quantity`) VALUES (5, "BD Black Diamond Momentum Ash scarpette arrampicata", "Black Diamond", 76.55, 1, "BD Black Diamond Momentum scarpette arrampicata sono la scelta giusta per chi è alla ricerca di un modello comodo e confortevole per compiere i primi passi in parete.
