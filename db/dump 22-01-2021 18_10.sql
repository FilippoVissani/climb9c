...
--
-- Host: localhost
-- Creato il: Gen 22, 2021 alle 18:10
...
INSERT INTO `customer` (`idCUSTOMER`, `name`, `surname`, `email`, `password`, `salt`, `telephone`, `gender`, `birthdate`) VALUES
...
--
ALTER TABLE `address`
  MODIFY `idADDRESS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `customer_address`
  MODIFY `idCUSTOMER_ADDRESS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT per la tabella `customer_notification`
--
ALTER TABLE `customer_notification`
  MODIFY `id_customer_notification` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `order`
--
ALTER TABLE `order`
  MODIFY `idORDER` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
