<div class="row mx-auto">
    <div class="col-12 p-0">
        <h1 class="mx-5 mb-0">NUOVI ARRIVI</h1>
    </div>
</div>

<div class="row mx-auto">
    <div class="col-12 p-0">
        <div id="productCarousel" class="carousel carousel-dark slide shadow p-5 m-5 bg-white rounded-pill-home"
    ...
    <div class="row my-2 mx-auto">
        <div class="col-md-6">
            <div class="card text-white shadow p-0 mb-5 mx-auto rounded-pill-home" id="home-card">
